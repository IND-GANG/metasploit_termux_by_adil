...
# Add Adil repository to install ruby 2.7.2 version
deb https://github.com/gushmazuko/metasploit_in_termux/raw/master gushmazuko main  | tee $PREFIX/etc/apt/sources.list.d/gushmazuko.list
